      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={4}>
          <TextField
            ...
            helperText={
              touchedFields["nombre"] && personalInfo.nombre === ""
                ? "El nombre es requerido"
                : ""
            }
            InputProps={{
              startAdornment: <LuUser className="mr-2" />,
            }}
          />
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <TextField
            ...
            onChange={(e) =>
              updatePersonalInfo("apellidoPaterno", e.target.value)
            }
        ...
        <Grid item xs={12} md={4}>
          <TextField
            ...
            onChange={(e) =>
              updatePersonalInfo("apellidoMaterno", e.target.value)
            }
        ...
        <Grid item xs={12}>
          <TextField
            ...
            helperText={
              touchedFields["alergias"] && personalInfo.alergias === ""
                ? "La información de alergias es requerida"
