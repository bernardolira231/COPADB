      ...
      <DialogContent sx={{ p: 3 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            {infoItem(
              "Registro SEP",
              <Typography variant="body1">{student.sep_register}</Typography>,
              "sep_register"
            )}
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            {infoItem(
              "Registro CPDB",
              <Typography variant="body1">{student.cpdb_register}</Typography>,
              "cpdb_register"
            )}
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            {infoItem(
              "CURP",
              <Typography variant="body1">{student.curp}</Typography>,
              "curp"
            )}
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            {infoItem(
              ...
              <Typography variant="body1">
                {student.allergies || "No especificado"}
              </Typography>,
              "allergies"
            )}
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            {infoItem(
              "Capilla",
              <Typography variant="body1">
                {student.chapel || "No especificado"}
              </Typography>,
              "chapel"
            )}
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            {infoItem(
              "Fecha de Registro",
              <Typography variant="body1">
                {new Date(student.reg_date).toLocaleDateString()}
              </Typography>,
              "reg_date"
            )}
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            {infoItem(
              "Permiso",
              <Typography variant="body1">
                {student.permission || "No especificado"}
              </Typography>,
              "permission"
            )}
          </Grid>
